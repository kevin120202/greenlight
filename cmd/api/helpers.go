...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	// This means that if the JSON from the client includes any filed which cannot be mapped to the target destiantion, the decoder will return an error
